  ...
  settingsPage: {
    ...
    account: {
      ...
      apiKeys: {
        ...
        createDescription: "キーに名前を付け、必要に応じて有効期限を設定します。",
        nameLabel: "名前",
        ...
        revoked: "失効済み",
        revoke: "失効",
        revokeConfirm: "この API キーを失効させますか？既存の連携は停止します。",
        secretTitle: "API キー secret を保存",
        secretDescription: "Secret は一度だけ表示されます。今すぐコピーしてサーバーまたは secret manager に保存してください。",
        secretWarning: "Secret をブラウザー保存、URL、ソースコード、ログ、チャットに置かないでください。",
