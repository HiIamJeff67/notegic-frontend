...
console.log(
  `Generated ${input("output")} from Gateway ${Object.values(gateway.paths || {}).reduce((count, item) => count + Object.keys(item).filter(key => !key.startsWith("x") && key !== "parameters").length, 0)} operations.`
);
