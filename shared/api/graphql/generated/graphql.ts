...
export type FragmentedBasicPrivateRoutineTaskFragment = { __typename?: 'PrivateRoutineTask', id: UUID, routineId: UUID, title: string, purpose: RoutineTaskPurpose, costUnit: number, priority: number, maxAttempts: number, previousRoutineTaskIds: Array<UUID>, updatedAt: Date, createdAt: Date } & { ' $fragmentName'?: 'FragmentedBasicPrivateRoutineTaskFragment' };
