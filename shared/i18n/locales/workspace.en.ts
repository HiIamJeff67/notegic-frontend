export const EnglishWorkspaceTranslation = {
  navigation: {
    ...
    settingsSheetDescription:
      "Manage Notegic settings without leaving the current workspace.",
  },
  accessibility: {
  ...
  records: {
    ...
    routineTitle: "Routine execution records",
    ...
    loadingRoutineRecords: "Loading routine execution records...",
    noRoutineRecords: "No routine execution records.",
    creationBarrier: "Deterministic creation barrier",
    creationBarrierDescription:
      "Container and core objects are prepared before dependent tasks continue.",
    creationBarrierProgress:
      "{{completed}} / {{total}} deterministic tasks complete",
  ...
  payloadEditor: {
    ...
    fakeId: "Execution fake ID",
    fakeIdExample: "e.g. f_0123456789abcdef0123456789abcdef",
    parentReference: "Parent reference",
    parentReferenceExample: "Existing UUID or f_ fakeId",
  ...
  menu: {
    ...
    orchestrateRoutineTasks: "Orchestrate tasks",
  ...
  validation: {
    ...
    dependencyCycle: "Dependencies cannot contain a cycle.",
    dependencyDuplicate: "This dependency already exists.",
    dependencyOutsideRoutine: "Dependencies must stay within this routine.",
  ...
  pages: {
    ...
    privacy: {
      ...
      collectIntro: "When you use Notegic, we may collect:",
  ...
  notifications: {
    ...
    routineDependencyGraphSaved:
      "Routine task graph saved locally. Backend sync is pending.",
    routineDependencyGraphSaveFailed:
      "Could not save the routine task graph locally.",
    dependencyCreationHint:
      "Select a source task, then a target task to create a dependency.",
